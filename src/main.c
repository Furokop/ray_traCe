...
int main() {
    ...
    body_rep sph1 = body_sphere_new(
        ...
        texture_new_single_color(color_new(0.1, 0.8, 0.4), 0.4));
    body_rep sph2 =
    ...
    body_rep sph3 = body_sphere_new(
        ...
        texture_new_single_color(color_new(0.9, 0.8, 0.4), 0.9));
    body_rep sph4 =
    ...
    body_rep sph5 = body_sphere_new(
        ...
        texture_new_single_color(color_new(0.5, 0.2, 0.9), 0.2));
